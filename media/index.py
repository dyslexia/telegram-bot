...
# MEDIA
blackhole = [
    os.path.abspath("media/blackhole1.jpg"),
    os.path.abspath("media/blackhole2.jpg"),
    os.path.abspath("media/blackhole3.jpg"),
    os.path.abspath("media/blackhole4.jpg"),
    os.path.abspath("media/blackhole5.jpg"),
    os.path.abspath("media/blackhole6.jpg"),
    os.path.abspath("media/blackhole7.jpg"),
]
